...
main: main.o Layer.o Player.o kbhit.o common.o Camera.o Color.o Animator.o Scene.o Talk.o Conversation.o AboveHeadComment.o
	g++ $(FLAGS) $^ -o $@
...
Scene.o: Scene.cpp Scene.h Layer.h Player.h Animator.h
	g++ $(FLAGS) -c $<
